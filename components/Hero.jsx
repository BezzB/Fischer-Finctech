...
const Hero = () => {
  return (
    <section className="hero-section relative flex flex-col items-center justify-center h-screen overflow-hidden" style={{ height: '50vh' }}>
      <Image
      ...
      <div className="hero-content absolute top-0 left-0 right-0 bottom-0 flex flex-col items-center justify-center px-2 py-2 text-center">
        ...
        <h2 className="text-2xl md:text-3xl lg:text-6xl font-bold mb-4 text-white"> We are a Leading Telecommunication Solutions Provider</h2>
