    ...
    <ul className="list-disc mb-4">
      ...
      <section className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
        <div className="md:w-1/2 order-2 md:order-1">
          ...
          <p className="mb-4">Ensure the reliability and security of your data with our comprehensive datacenter services.</p>
          <ul className="list-disc pl-6 mb-4">
            <li>Design and Setup</li>
            <li>Equipment Supply, Installation, Configuration, and Maintenance</li>
      ...
      <section className="flex flex-col md:flex-row items-center justify-center gap-8 mb-8">
        ...
        <div className="md:w-1/2">
          <h2 className="text-2xl font-semibold mb-4">Management As A Service (MaaS)</h2>
          <p className="mb-4">Optimize your office network infrastructure with our management as a service offering.</p>
          <ul className="list-disc pl-6 mb-4">
            <li>Complete Management of Day-to-Day Office Network Infrastructure</li>
            <li>Advisory on Turnkey Solutions for Effective Office Automation</li>
